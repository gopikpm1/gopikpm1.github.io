...
const skillCategories: SkillCategory[] = [
  {
    ...
    tags: [
      ...
      'Installable PWA (Manifest + Service Workers)',
      'PWA Push & Offline Support',
    ],
    appliedIn: [
  ...
  {
    icon: 'fas fa-desktop',
    category: 'Desktop App Development (Electron)',
    tags: [
      'Electron',
      'Electron Builder',
      'Electron Forge',
      'Windows Apps (NSIS / Squirrel / MSI)',
      'macOS Apps (DMG / Mac App Store)',
      'Linux Apps (AppImage / deb)',
      'Auto Updates',
      'IPC & Native APIs',
  ...
  {
    icon: 'fas fa-code',
    category: 'Web, Website & PWA Development',
    tags: [
      'JavaScript (ES6+)',
      'TypeScript',
      'React',
  ...
  {
    icon: 'fas fa-wrench',
    category: 'DevOps, CI/CD & App Deployment',
    tags: [
      ...
      'Windows Desktop Packaging (Electron Builder)',
      'macOS Desktop Packaging (DMG / Notarization)',
      'Desktop Auto-Update Releases',
      'Web / PWA Deployment (Netlify / Hosting)',
      'Xcode',
      'Android Studio',
      'Git',
      'CI/CD',
